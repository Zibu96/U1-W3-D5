...
*/
let random = Math.floor(Math.random(0)*21) 
console.log(random)
/* ESERCIZIO C
...
*/
const dice = function () {
 const play=  Math.ceil(Math.random(0)*6)
 return play
}
console.log(dice(0))
...
console.log(splitMe("ciao belli, come state oggi?"))
/* ESERCIZIO 4
  Crea una funzione chiamata "deleteOne" che riceve una stringa e un booleano come parametri.
  Se il valore booleano è true la funzione deve ritornare la stringa senza il primo carattere, altrimenti la deve ritornare senza l'ultimo.
*/
const deleteOne = function (string, par) {
  if (par === true) {
...
console.log(onlyLetters("Sono nato nel 1996"))
/* ESERCIZIO 6
  Crea una funzione chiamata "isThisAnEmail" che riceve una stringa come parametro e ritorna true se la stringa è un valido indirizzo email.
*/
const isThisAnEmail = function (string) {
  if (string.includes("@",".") === true){
    return "questa è una email"
  }
  else 
  return "questa non è una mail"
}
console.log(isThisAnEmail("giannijuve@alice.it"))
console.log(isThisAnEmail("giannijue.alice.it"))
/* ESERCIZIO 7
...
console.dir(rollTheDices())
/* ESERCIZIO 9
  Scrivi una funzione chiamata "howManyDays" che riceve una data come parametro e ritorna il numero di giorni trascorsi da tale data.
*/
const today = new Date
const howManyDays = function (date) {
const dayDifference = today.getTime() - date.getTime();

return Math.floor(dayDifference / (1000 * 60 * 60 * 24)) 
}
console.log(howManyDays(new Date(2023,11,25)))
/* ESERCIZIO 10
  Scrivi una funzione chiamata "isTodayMyBirthday" che deve ritornare true se oggi è il tuo compleanno, falso negli altri casi.
*/
const isTodayMyBirthday = function () {
  if (new Date === new Date("September 28")){
...
const onlyTheYears = function () {
 return movies.map((year) => year.Year)
}
...
const onlyInLastMillennium = function () {
  ...
  return parseInt(year.Year) < 2000})
}
